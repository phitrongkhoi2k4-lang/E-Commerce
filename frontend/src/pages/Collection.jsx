...
const Collection = () => {
  ...
  const {products, search, showSearch, getProductPrice} = useContext(ShopContext);
  ...
  const sortProduct = () =>{
    ...
    switch(sortType){
      case 'low-high':
        setFilterProducts(fpCopy.sort((a,b)=>(getProductPrice(a) - getProductPrice(b))));
        break;
      case 'high-low':
        setFilterProducts(fpCopy.sort((a,b)=>(getProductPrice(b) - getProductPrice(a))));
        break;
      default:
        applyFilter();
        break;
